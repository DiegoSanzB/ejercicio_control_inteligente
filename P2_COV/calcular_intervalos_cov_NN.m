...
function [alfa_optimo, alfas, porcentaje_datos] = calcular_intervalos_cov_NN(x_optim_ent, x_optim_test, x_optim_val, net_optim_structure, Y, y_hat_ , y_hat, target_porcentaje)
